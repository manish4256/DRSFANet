...
parser.add_argument('--weightsPath',dest='weightsPath',type=str,default='./Pretrained_models/final_new.h5',help='pathOfTrainedCNN')
...
for i in range(0,lenth):
    ...
    z=(predClean)
    cv2.imwrite("./25new/"+str(i+1)+"_Original.png",255.*img1)
    cv2.imwrite("./25new/"+str(i+1)+"_Proposed.png",255.*z)
    cv2.imwrite("./25new/"+str(i+1)+"_Noisy.png",255.*f)
