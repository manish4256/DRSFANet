...
parser.add_argument('--weightsPath',dest='weightsPath',type=str,default='./Pretrained_models/itsnew.h5',help='pathOfTrainedCNN')
...
for i in range(0,length):
    ...
    cv2.imwrite("./results/"+str(i+1)+"_Proposed.png",255.*z)
